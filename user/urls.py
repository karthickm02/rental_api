...
urlpatterns = [
    ...
    path("user/products/<int:user_id>/", views.get_product),
    path("user/my-products/<int:user_id>/", views.get_my_product),
    path("user/accept-rent/<int:rent_id>/", views.response_rent)
]